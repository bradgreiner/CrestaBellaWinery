...
export default function FeatureCard({
  ...
  return (
    <div className="group flex flex-col h-full text-center p-8 sm:p-10 rounded-sm bg-cream-light border-t-2 border-burgundy hover:bg-cream transition-colors duration-300">
      ...
      <p className="text-charcoal/70 leading-relaxed text-sm sm:text-base mb-6 flex-1">
        {description}
      </p>
      {href && linkText && (
        <Link
          href={href}
          className="inline-flex items-center gap-1.5 text-xs tracking-[0.15em] uppercase font-sans text-burgundy/70 hover:text-burgundy transition-colors mt-auto"
        >
          {linkText}
